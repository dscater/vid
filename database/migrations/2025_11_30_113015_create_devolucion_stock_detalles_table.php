...
return new class extends Migration
{
    ...
    {
        Schema::create('devolucion_stock_detalles', function (Blueprint $table) {
            $table->id();
            ...
            $table->timestamps();
            $table->foreign("devolucion_stock_id")->on("devolucion_stocks")->references("id");
    ...
    {
        Schema::dropIfExists('devolucion_stock_detalles');
    }
};
