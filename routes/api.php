...
Route::middleware(['auth:api'])->prefix("admin")->group(function () {
    ...
    Route::get("sucursal_productos/listaProductosExistentesConStock", [SucursalProductoController::class, 'listaProductosExistentesConStock'])->name("sucursal_productos.listaProductosExistentesConStock");
