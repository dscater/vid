...
use App\Rules\DevolucionClienteDetalleRule;
use Illuminate\Foundation\Http\FormRequest;

class DevolucionClienteStoreRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            "hora" => "required",
            "total" => "required",
            "devolucion_cliente_detalles" => ["required", new DevolucionClienteDetalleRule()],
    ...
    public function messages(): array
    {
        return [
            ...
            "cliente_id" => "Debes completar este campo",
            ...
            "devolucion_cliente_detalles" => "Debes agregar al menos 1 producto",
        ];
    }
}
